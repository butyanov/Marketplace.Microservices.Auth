...
public static class ValidationMessages
{
    ...
    public const string EmptyBearerToken = "Bearer token field cannot be empty or null";
    public const string EmptyRefreshToken = "Refresh token field cannot be empty or null";
}